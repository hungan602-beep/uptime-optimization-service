...
console.log(`Checking Stealth Runs for: ${repo}`);

const options = {
    hostname: 'api.github.com',
    path: `/repos/${repo}/actions/workflows/e2e-tests.yml/runs?per_page=50`,
    method: 'GET',
    headers: {
        'User-Agent': 'Node.js',
...
const req = https.request(options, (res) => {
    ...
    res.on('end', () => {
        ...
        console.log(`Total Stealth Runs: ${data.total_count}`);
